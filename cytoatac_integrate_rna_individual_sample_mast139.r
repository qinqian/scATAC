...
mast139 = proj2[proj2$Sample=='SJRHB013758_X2', ]
...
plotPDF(p4, name = "MAST139_RMS_ATAC_Plot-UMAP-Clusters.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)


mast139 = proj_tmp[!(proj_tmp$ClustersHarmony_individualsample%in%c('C1', 'C2')), ]
...
p4 <- plotEmbedding(ArchRProj = proj_tmp, colorBy = "cellColData", name = "ClustersHarmony_individualsample", embedding = "UMAP")
plotPDF(p4, name = "MAST139_RMS_ATAC_Plot-UMAP-Clusters-RemoveC12.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)
...
readr::write_csv(clusters, path='MAST139_RemoveC12_StJude_cluster_enrichr_filter_annotation.csv')
...
state = unlist(meta['MAST139', , drop=T])
state = state[!((state=='') | (is.na(state)))]

## print(state)
levels(MAST139$RNA_snn_res.0.8) = state
...
plotPDF(p4, name = "MAST139_RMS_ATAC_Plot-UMAP-Clusters-RemoveC12-annotation-by-rna.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)
...
groupList <- SimpleList(
    MEP = SimpleList(
        ...
        RNA = colnames(MAST139)[grep("Muscle", MAST139$RNA_snn_res.0.8)]
    ),
    NonMEP = SimpleList(
        ATAC = proj_tmp$cellNames[!(proj_tmp$ClustersHarmony_individualsample %in% clustMuscleEMTProlif)],
        RNA = colnames(MAST139)[-grep("Muscle", MAST139$RNA_snn_res.0.8)]
...
plotPDF(p4, name = "MAST139_RMS_ATAC_Plot-UMAP-CoClusters-RemoveC12-annotation-by-rna.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)
...
plotPDF(plotList = p, 
        name = "MAST139-Plot-UMAP-Marker-Genes-WO-Imputation.pdf",
        ArchRProj = proj_tmp,
...
plotPDF(plotList = p, 
        name = "MAST139-RMS-Plot-Tracks-Marker-Genes.pdf",
        ArchRProj = proj_tmp,
...
plotPDF(plotList = list(p1, p2), 
        name = "MAST139-Plot-UMAP-Marker-Genes-RNA-W-Imputation.pdf", 
        ArchRProj = proj_tmp, 
        addDOC = FALSE, width = 5, height = 5)

p4 <- plotEmbedding(ArchRProj = proj_tmp, colorBy = "cellColData", name = "predictedGroup", embedding = "UMAP")
plotPDF(p4, name = "MAST139_RMS_ATAC_Plot-UMAP-FinalClusters-RemoveC12-annotation-by-rna.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)
...
plotPDF(heatmapPeaks, name = "MAST139-Peak-Marker-Heatmap", width = 8, height = 6, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(pma, pv, name = "MAST139-EMT-Markers-MA-Volcano", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(p, name = "MAST139-EMT-Plot-Tracks-With-Features", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(pma, pv, name = "MAST139-EMT-vs-Ground-Markers-MA-Volcano", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(heatmapEM, name = "MAST139-Motifs-Enriched-Marker-Heatmap", width = 9, height = 20, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(heatmapEncode, name = "MAST139-EncodeTFBS-Enriched-Marker-Heatmap", width = 8, height = 6, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(heatmapATAC, name = "MAST139-ATAC-Enriched-Marker-Heatmap", width = 8, height = 6, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(plotVarDev, name = "MAST139-Variable-Motif-Deviation-Scores", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plot_fp1 = plotFootprints(
  ...
  ArchRProj = proj_tmp, 
  normMethod = "Divide",
  plotName = "MAST139-Plot-Groups-Footprints-Divide-Bias",
  addDOC = FALSE,
  smoothWindow = 5
)
