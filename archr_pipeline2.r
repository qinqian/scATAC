...
ArrowFiles <- createArrowFiles(inputFiles = 'MSK93202_hg38/outs/fragments.tsv.gz',
                               sampleNames = 'MSK93202',
                               minTSS = 4, 
                               minFrags = 1000,
                               addTileMat = TRUE,
...
tsne = read.csv('MSK93202/outs/analysis/tsne/2_components/projection.csv', row.names=1)
...
rownames(metadata) = paste0('MSK93202#', rownames(metadata))
...
plotPDF(p4, name = "MSK93202_RMS_ATAC_Plot-UMAP-Clusters.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)
...
readr::write_csv(clusters, path='MSK93202_cluster_enrichr_filter_annotation.csv')

## rna = readRDS('/PHShome/qq06/langenau/geo_upload/geo_submission_scrms_june21/processed_data_files/')
...
## plotPDF(p4, name = "MSK93202_RMS_ATAC_Plot-UMAP-Clusters-RemoveC12-annotation-by-rna.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)
...
## plotPDF(p4, name = "MSK93202_RMS_ATAC_Plot-UMAP-CoClusters-RemoveC12-annotation-by-rna.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)
...
plotPDF(plotList = p, 
        name = "MSK93202-Plot-UMAP-Marker-Genes-WO-Imputation.pdf",
        ArchRProj = proj_tmp,
...
## plotPDF(plotList = p, 
##         name = "MSK93202-RMS-Plot-Tracks-Marker-Genes.pdf",
##         ArchRProj = proj_tmp,
...
plotPDF(plotList = list(p2), 
        name = "MSK93202-Plot-UMAP-Marker-Genes-RNA-W-Imputation.pdf", 
        ArchRProj = proj_tmp, 
        addDOC = FALSE, width = 5, height = 5)

## p4 <- plotEmbedding(ArchRProj = proj_tmp, colorBy = "cellColData", name = "predictedGroup", embedding = "UMAP")
## plotPDF(p4, name = "MSK93202_RMS_ATAC_Plot-UMAP-FinalClusters-RemoveC12-annotation-by-rna.pdf", ArchRProj = proj_tmp, addDOC = FALSE, width = 5, height = 5)

## proj_tmp <- addGroupCoverages(ArchRProj = proj_tmp, groupBy = "predictedGroup")
proj_tmp <- addGroupCoverages(ArchRProj = proj_tmp, groupBy = "ClustersHarmony_individualsample")
## Use macs2
...
plotPDF(heatmapPeaks, name = "MSK93202-Peak-Marker-Heatmap", width = 8, height = 6, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(pma, pv, name = "MSK93202-EMT-Markers-MA-Volcano", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(p, name = "MSK93202-EMT-Plot-Tracks-With-Features", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(pma, pv, name = "MSK93202-EMT-vs-Ground-Markers-MA-Volcano", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(heatmapEM, name = "MSK93202-Motifs-Enriched-Marker-Heatmap", width = 9, height = 20, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(heatmapEncode, name = "MSK93202-EncodeTFBS-Enriched-Marker-Heatmap", width = 8, height = 6, ArchRProj = proj_tmp, addDOC = FALSE)
...
## plotPDF(heatmapATAC, name = "MSK93202-ATAC-Enriched-Marker-Heatmap", width = 8, height = 6, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(heatmapCodex, name = "MAST139-Codex-Enriched-Marker-Heatmap", width = 8, height = 6, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(plotVarDev, name = "MSK93202-Variable-Motif-Deviation-Scores", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(p, name = "MAST139-Plot-Groups-Deviations-w-Imputation", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plotPDF(p1,p2,p3, name = "MAST139-Plot-Groups-Deviations-w-Imputation-on-UMAP", width = 5, height = 5, ArchRProj = proj_tmp, addDOC = FALSE)
...
plot_fp1 = plotFootprints(
  ...
  ArchRProj = proj_tmp, 
  normMethod = "Subtract",
  plotName = "MAST139-Plot-Groups-Footprints-Subtract-Bias",
  addDOC = FALSE,
  smoothWindow = 5
)
...
plot_fp1 = plotFootprints(
  ...
  ArchRProj = proj_tmp, 
  normMethod = "Divide",
  plotName = "MSK93202-Plot-Groups-Footprints-Divide-Bias",
  addDOC = FALSE,
  smoothWindow = 5
)
